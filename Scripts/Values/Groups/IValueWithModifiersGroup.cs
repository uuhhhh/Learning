...
public interface IValueWithModifiersGroup
{
    ...
    ///     The type of value that the IValueWithModifiers holds,
    ///     and the type of value the modifier modifies
    /// </typeparam>
    /// <exception cref="ArgumentException">
    ///     If the modifier type parameter and the
    ///     IValueWithModifiers type parameter don't match.
    /// </exception>
