...
public partial class EnvObjectData : Resource {
    ...
    [Export] public int FloorPriority {
        get => UseFloorDefaultPriority && Floor != null ? Floor.FloorDefaultPriority : _floorPriority;
    ...
    [Export] public int WallPriority {
