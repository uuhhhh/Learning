...
public partial class AirData : Resource
{
    ...
    /// </summary>
    [Export]
    public FallingDataMultiplier AirFalling { get; private set; }

    /// <summary>
    ///     Data used for modifying the horizontal movement of the entity when in the air.
    /// </summary>
    [Export]
    public LeftRightDataMultiplier AirMovement { get; private set; }

    /// <summary>
    ///     Data used for modifying the entity's air jumping.
    /// </summary>
    [Export]
    public JumpingDataModifier AirJumping { get; private set; }
