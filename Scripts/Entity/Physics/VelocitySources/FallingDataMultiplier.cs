...
public partial class FallingDataMultiplier : ModifierResource<FallingData> {
    ...
    [Export] public FloatMultiplier DownwardsGravityScaleMultiplier {
    ...
    [Export] public FloatMultiplier MaxFallVelocityMultiplier {
    ...
    [Export] public FloatMultiplier CeilingHitStopTimeScaleMultiplier {
    ...
    [Export] public FloatMultiplier DecelToMaxVelocityTimePer100VelocityMultiplier {
