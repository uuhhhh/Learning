...
public partial class Jumping : Node
{
    ...
    /// </summary>
    [Export]
    private bool CoyoteGroundJumpEnabled { get; set; } = true;
    ...
    /// </summary>
    [Export]
    private bool GroundJumpBufferEnabled { get; set; } = true;
    ...
    /// </summary>
    [Export]
    private bool CoyoteWallJumpEnabled { get; set; } = true;
    ...
    /// </summary>
    [Export]
    private bool WallJumpBufferEnabled { get; set; } = true;
    ...
    ///     The x component of the wall normal. The wall being to the left
    ///     of the entity corresponds to a positive value.
    /// </param>
