...
public partial class PlayerParticles : Node2D {
    ...
    private void WalkCheck(Player player) {
        WalkingParticles.Emitting =
            player.IsOnFloor() && !player.IsOnWall() && player.PlayerController.LeftRight.CurrentSpeedScale != 0;
    }
    ...
    private void InitFloorImpactBehavior(Player player) {
        ...
        player.PlayerController.WallDragging.StoppedDragging += () => RecordFallStartPosition(player);
